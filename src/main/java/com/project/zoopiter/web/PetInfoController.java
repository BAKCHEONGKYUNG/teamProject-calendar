...
//    String save = petInfoSVC.saveInfo(petInfo);
  ...
  // 등록처리
//  PetNoteDAO saveInfo(PetNoteDAO petInfo);
  @PostMapping("/petreg")
  public String save(
...
//    return "mypage/mypage_pet_modify";
  ...
  public String findInfo(
    ...
    PetInfo petInfo = findPetInfo.orElseThrow(() -> new RuntimeException("PetNoteDAO not found for id: " + id));
...
//  int updateInfo (Long PetNum, PetNoteDAO petInfo);
  // 수정양식
  @GetMapping("/{id}/edit")
...
//    modifyForm.setUserEmail(member.getUserEmail());
